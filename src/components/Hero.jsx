...
const Hero = () =>   (
  ...
  <div className={`flex-1 ${styles.flexStart } flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <h1 className=" font-poppins font-semibold ss:text-[64px] text-[52px] text-white ss:leading-[100px]
        leading-[75px] w-full"> Payment Method.
          </h1>
       <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology
        to identify the faulty phones most likely 
        to fix your needs.
  ...
  <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
     <img src={robot} alt='billing' className='w-[120%] h-[100%] relative z-[5]'/>
     <div className='absolute z-[1] w-[40%] h-[32%] bottom-40 pink__gradient'/>
